...
"$FF" -y -loop 1 -t 8.33 -i "$A/bg.png" -ss 2.0 -t 10.0 -i "$TAKE" \
...
"$FF" -y -loop 1 -t 5.04 -i "$A/bg.png" -ss 14.2 -t 6.8 -i "$TAKE" \
...
"$FF" -y -loop 1 -t 7.26 -i "$A/bg.png" -ss 20.4 -t 9.8 -i "$TAKE" \
...
"$FF" -y -loop 1 -t 10.14 -i "$A/bg.png" -ss 29.8 -t 14.2 -i "$TAKE" \
